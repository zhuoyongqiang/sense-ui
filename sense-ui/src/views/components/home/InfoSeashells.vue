<template>
  <div class="seashells" :style="{height:height}">
    ...
    <div class="seashellsMain seashellPadding"  v-if="dataList.length!=0">
      <ul @click="showDetail(item.id)" v-for="item in dataList">
        ...
        <!-- <li>
          <p class="seashellTitle">{{ item.abtract }}</p>
        </li>
        <li>
          <ul class="seashellULImg">
            <li v-for="(img,index) in item.contentImagePathArr" v-if="index<3">
              <img :src="img" alt="" height="86">
            </li>
          </ul>
        </li> -->
      </ul>
