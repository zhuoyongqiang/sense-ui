<template>
  <div class="flag">
    <div class="publicFlex publicBorder">
      ...
      <div class="publicTitleMore" v-if="isMore===true">
    ...
    <div class="flagContent publicContent publicFlex">
      <iframe :src="url"  frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" :style="{'width': '100%','height':maxHeight}"></iframe>
    </div>
  </div>
</template>
...
<script>
  export default {
    name: "infoIframe",
    props: ['icon', 'title', 'url', 'params', 'maxHeight',"moreName",'morelink','linkType','isMore'],
    data() {
    },
    methods: {
      showMore() {
