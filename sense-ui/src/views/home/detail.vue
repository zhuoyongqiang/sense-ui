      ...
      <div class="left-header ">
        <div class="header-navbar">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item><a href="/home/window/1009">公告中心</a></el-breadcrumb-item>
      ...
      <div class="left-center">
        <div class="article-main">
          ...
          <div class="article-info clearfix">
            <span><i class="el-icon-time"></i>发表于 {{ form.releaseTime }}</span>
          ...
          <iframe id="frame" ref="frame" name="frame"   style="width:100%;min-height: 200px;" frameborder="no"></iframe>
          <div class="article-attach" v-if="form.fileList!=undefined && form.fileList.length>0">
            <el-table :data="form.fileList" style="width: 100%">
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <a :href="scope.row.url" :download="scope.row.name" style="color:blue">下载</a>
                </template>
              </el-table-column>
            </el-table>
          </div>
...
<script>
  ...
  import $ from 'jquery';
  import {getNotice} from "@/api/console/info/notice";
  import {addInfoLog } from "@/api/console/info/log";
  export default {
    name: "detailTemplate",
    components: {InfoLogin, ElImageViewer},
    data() {
      return {
        initialIndex: 0,
      	imgList: [],
      ...
      getInfo(id) {
        getNotice(id).then(response => {
          if (response.code == 200) {
            ...
            this.secondLink = '/home/window/' + 1009;
            ...
            const timer = setTimeout(() =>{
              ...
              iframe.document.write('</style>');
              iframe.document.write('</head>');
              iframe.document.write("<body id='content' name='content'>");
