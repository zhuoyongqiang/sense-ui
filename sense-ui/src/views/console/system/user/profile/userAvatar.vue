<template>
  <div>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body @opened="modalOpened" @close="handleClose">
      <el-row>
...
import {uploadAvatar} from "@/api/console/system/user";
